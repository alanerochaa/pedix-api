...
public class PedidoItemController {
    ...
    @Operation(
            ...
            description = "Retorna todos os itens vinculados aos pedidos cadastrados no sistema, incluindo links HATEOAS para navegação."
    )
    @GetMapping
    public ResponseEntity<List<EntityModel<PedidoItemResponseDTO>>> listarTodos() {
        ...
        List<EntityModel<PedidoItemResponseDTO>> resposta = service.listarTodosDTO().stream()
                .map(dto -> EntityModel.of(
                        dto,
                        linkTo(methodOn(PedidoItemController.class)
    ...
    public ResponseEntity<EntityModel<PedidoItemResponseDTO>> buscarPorId(@PathVariable Long id) {
        ...
        EntityModel<PedidoItemResponseDTO> model = EntityModel.of(
                dto,
    ...
    public ResponseEntity<Map<String, Object>> criar(
        ...
        Map<String, Object> body = Map.of(
                ...
                "_links", Map.of(
                        "self", linkTo(methodOn(PedidoItemController.class)
                                .buscarPorId(resp.getId()))
                                .toUri(),

                        "todos_itens", linkTo(methodOn(PedidoItemController.class)
                                .listarTodos())
                                .toUri(),

                        "pedido", linkTo(methodOn(PedidoController.class)
                                .obter(resp.getPedidoId()))
                                .toUri()
                )
        );
